...
PATH_TO_SAVE_FINETUNED_MODEL_METRIC_HISTORY = "../../../../data/ml/med_distilbert_base_russian_cased/metric_history.csv"
PATH_TO_SAVE_FINETUNED_MODEL = "../../../../data/ml/med_distilbert_base_russian_cased/model"
