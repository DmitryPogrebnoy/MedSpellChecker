...
from medspellchecker.tool.gpu_utils import print_gpu_memory_stats, set_device

MODEL_CHECKPOINT = "microsoft/mdeberta-v3-base"
PATH_TO_PREPROCESSED_ANAMNESIS = "../../../../data/anamnesis/processed/all_anamnesis.csv"

PATH_TO_NEW_TOKENIZER = "../../../../data/ml/med_mdeberta/tokenizer"
...
FP16_TRAINING_ARG = False

PATH_TO_SAVE_FINETUNED_MODEL_METRIC_HISTORY = "../../../../data/ml/med_mdeberta/metric_history.csv"
PATH_TO_SAVE_FINETUNED_MODEL = "../../../../data/ml/med_mdeberta/model"
...
def fine_tune_model():
    ...
    accelerator = Accelerator(mixed_precision="fp16" if training_args.fp16 else None, cpu=True, device_placement=False)
