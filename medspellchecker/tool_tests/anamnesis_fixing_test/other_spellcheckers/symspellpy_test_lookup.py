...
def symspell_py_lookup_test(input_sentence):
...
if __name__ == '__main__':
    """
    Run test for SymSpellPy (lookup method)
    """
    perform_anamnesis_fixing_test(symspell_py_lookup_test, "symspellpy_fix.csv")
